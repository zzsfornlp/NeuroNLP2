...
PYTHONPATH=${SRC_DIR} python3 ${SRC_DIR}/examples3/train/parser.py \
--mode FastLSTM --num_epochs 300 --batch_size 32 --hidden_size 512 --num_layers 3 \
--pos_dim 0 --char_dim 30 --num_filters 30 --arc_space 512 --type_space 128 \
--opt adam --learning_rate 0.001 --decay_rate 0.75 --epsilon 1e-4 --schedule 10 --gamma 0.0 --clip 5.0 \
--p_in 0.33 --p_rnn 0.33 0.33 --p_out 0.33 --unk_replace 0.5 --char \
