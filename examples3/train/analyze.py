...
# debug
# CUDA_VISIBLE_DEVICES=1 PYTHONPATH=../src/ python3  ../src/examples3/train/analyze.py --parser biaffine --gpu --punctuation SYM PUNCT --test ../data/ud23/enf_test2.conllu --model_name 'network.pt' --model_path  ../zp_enf/models/
