...
def main():
    ...
    word_alphabet, char_alphabet, pos_alphabet, type_alphabet = conllx_data.create_alphabets(alphabet_path, train_path, data_paths=[dev_path,test_path], max_vocabulary_size=50000, embedd_dict=embedd_dict)
    ...
    for epoch in range(1, num_epochs + 1):
        ...
        for batch in range(1, num_batches + 1):
            ...
            train_err += float(loss) * num_tokens
